...
export default function AddProduct() {
  ...
  if (success) {
    return (
      <Layout title="Produk Berhasil Ditambahkan">
  ...
  return (
    <Layout 
      ...
      description="Tambahkan produk desa baru ke dalam database"
    >
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Lengkapi informasi produk desa yang akan didaftarkan</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  {errors.harvestSeason && <p className="text-red-600 text-sm mt-1">{errors.harvestSeason}</p>}
                </div>
              </div>
            </div>
            ...
            {/* Price & Location */}
            <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-6">Harga & Lokasi</h2>
